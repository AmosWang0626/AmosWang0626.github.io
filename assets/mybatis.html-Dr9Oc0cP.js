import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{e as a,f as e,o as i}from"./app-BCtReGRE.js";const t={};function l(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="mybatis-2017-5-16" tabindex="-1"><a class="header-anchor" href="#mybatis-2017-5-16"><span>MyBatis （2017.5.16）</span></a></h1><blockquote><p>MyBatis 主要是处理数据的持久化操作的一个轻量级框架，相对于Hibernate而言。</p></blockquote><hr><h2 id="实现数据持久化操作主要有两点" tabindex="-1"><a class="header-anchor" href="#实现数据持久化操作主要有两点"><span>实现数据持久化操作主要有两点：</span></a></h2><pre><code>1. 底层配置文件
